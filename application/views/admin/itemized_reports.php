...
<head>
        ...
        <!-- App Title -->
        <title><?php echo $title;?> | Itemized Reports</title>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <h4 class="page-title">Itemized Reports</h4>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="card-box table-responsive">
                                                ...
                                                <form name="from" method="post" action="<?php echo base_url('admin/reports/itemized_report');?>">
                <table >
                ...
                <br>
                        ...
                        <div class="clearfix"></div>
                            ...
                            <?php if($_POST)  { ?>
                     <form name="from" method="post" target="_blank" action="<?php echo base_url('admin/reports/itemized_reportprint');?>">                     
