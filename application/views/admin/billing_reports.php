    ...
    <body>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <h4 class="page-title">Bakes Reports</h4>
               ...
               <?php 
                    ...
                    $quo=$this->db->get('addbilling')->result_array();
                  ?>
       ...
       <script type="text/javascript">
        $(document).ready(function(){
            $('#billingreports').attr('class','has-submenu active');
...
$(document).ready(function() {
    ...
    table = $('#table').DataTable({ 
        ...
        "ajax": {
            "url": "<?php echo site_url('admin/add_billing/ajax_list')?>",
            "type": "POST",
            "data": function ( data ) {
    ...
    $('#btn-reset').click(function(){ //button reset event click
     ...
     $('#print').click(function(){
        ...
        $.post('<?php echo base_url();?>admin/add_billing/billing_reportprints',{'fromdate':fromdate,'todate':todate,'billno':billno},function(data){
     ...
     $('#download').click(function(){
        ...
        $.post('<?php echo base_url();?>admin/add_billing/billing_reportdownload',{'fromdate':fromdate,'todate':todate,'billno':billno},function(data){
