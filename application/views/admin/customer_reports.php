...
<head>
        ...
        <!-- App Title -->
        <title><?php echo $title;?> | Customer Reports</title>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="card-box table-responsive">
                                               ...
                                               <!--  <form name="from" method="post" action="<?php echo base_url('admin/add_billing/billing_report');?>">
                <table >
                
                <tr>
                  <td>
                  <div class="col-sm-12">
                  <input type="text" name="fromdate" class="form-control date" id=""  Placeholder="From Date">
                  </div>
                  </td>

                  <td>
                    <div class="col-sm-12">
                  <input type="text" name="todate" class="form-control date" id=""  Placeholder="To Date">
                  </div>
                  </td>
                ...
                <br> -->
                        ...
                        <div class="clearfix"></div>
                            <table id="table" class="table table-striped table-bordered">
                                ...
                                <?php 
                                $i=1;
                                foreach ($customerreports as $row) {
