...
<head>
        ...
        <!-- App Title -->
         <title><?php echo $title;?> | Chats</title>
    ...
    <body>
        ...
        <div class="wrapper">
            <div class="container">
                ...
                <?php }?>
                  ...
                  <form method="post" action="<?php echo base_url();?>admin/add_chats/addbill" target="_blank" onsubmit="setTimeout(function () { location.href = '<?php echo base_url();?>admin/add_chats'; })">
       ...
       <script type="text/javascript">
        $(document).ready(function(){
            $('#addchats').attr('class','has-submenu active');
...
//autocomplete ----itemname-----------------
  $( "#itemname").autocomplete({
          ...
          source: function(request, response) {
            $.ajax({ 
              url: "<?php echo base_url();?>admin/add_chats/searchitem",
  ...
  //itemchange & blur fuunction-----------------
   $('#itemname').change(function(){
    var itemname=$('#itemname').val();
    $.post('<?php echo base_url();?>admin/add_chats/searchrate',{'itemname':itemname},function(data){
...
$(document).keypress(function(e){
    if (e.which == 13){
      ...
      $('#lists').append('<tr><td>'+ itemname +'</td><td>'+ qty +'</td><td>'+ rate +'</td><td>'+ amount +'<input type="hidden" name="itemnames[]" class="form-control" value="'+ itemname +'"  id="itemnames"><input type="hidden" name="qtys[]" class="form-control" value="'+ qty +'"  id="qtys"><input type="hidden" name="rates[]" class="form-control" value="'+ rate +'"  id="rates"><input type="hidden" name="amounts[]" class="form-control" value="'+ amount +'"  id="amounts"></td><td><a href="javascript:void()" title="Delete"  class="btn btn-icon  waves-effect waves-light btn-danger clear"> <i class="fa fa-remove"></i> </a></td></tr>'); 
