                    ...
                    <div class="col-md-12">
                        <div class="card-box">
                            ...
                            <?php 
                                            ...
                                            ?>
                            <form method="post" action="<?php echo base_url();?>admin/profile/updateprofile" id="form_sample_1" enctype="multipart/form-data" data-parsley-validate novalidate>
                            <div class="col-md-6">
                                <div class="form-group">
                                 <input type="hidden" name="id"  value="<?php echo $row['id'];?>">
                                                <label for="userName">Title<span class="text-danger">*</span></label>
                                                <input type="text" name="title"  value="<?php echo $row['title'];?>" data-parsley-minlength="2" parsley-trigger="change" required placeholder="Enter Title" class="form-control" id="title">
                                            </div>
