                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="card-box table-responsive">
                             ...
                             <div class="col-sm-6">
                                        <div class="m-b-30">
                                            <button  id="addToTable" onclick="add_person()" class="btn btn-default waves-effect waves-light">Add Product <i class="fa fa-plus"></i></button>
...
$(document).ready(function() {
    ...
    table = $('#table').DataTable({ 
        ...
        "ajax": {
            "url": "<?php echo site_url('admin/add_product/ajax_list')?>",
            "type": "POST"
        },
...
function add_person()
{
    ...
    $.post('<?php echo base_url();?>admin/add_product/addproductid',function(data){
...
function edit_person(id)
{
    ...
    $.ajax({
        url : "<?php echo site_url('admin/add_product/ajax_edit/')?>/" + id,
        type: "GET",
        dataType: "JSON",
...
function delete_person(id)
{
    if(confirm('Are you sure delete this Product?'))
    {
        ...
        $.ajax({
            url : "<?php echo site_url('admin/add_product/ajax_delete')?>/"+id,
            type: "POST",
            dataType: "JSON",
            success: function(data)
            {
...
function checkproductname()
{
    ...
    //alert(category);
     ...
     $.post('<?php echo base_url();?>admin/add_product/checkproductname',{'productname':productname},function (data){
...
function reload_table()
{
 ...
 $('#btnSave').text('saving...'); //change button text
    ...
    if(save_method == 'add') {
        url = "<?php echo site_url('admin/add_product/ajax_add')?>";
    } else {
        url = "<?php echo site_url('admin/add_product/ajax_update')?>";
    }
