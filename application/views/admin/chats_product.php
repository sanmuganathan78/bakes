...
<head>
        ...
        <!-- App Title -->
        <title><?php echo $title;?> | Product List</title>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="card-box table-responsive">
                             ...
                             <div class="col-sm-6">
                                        <div class="m-b-30">
                                            <button  id="addToTable" onclick="add_person()" class="btn btn-default waves-effect waves-light">Add Chat Product <i class="fa fa-plus"></i></button>
                                        ...
                                        <div class="modal-dialog"> 
                                            <div class="modal-content"> 
                                                <div class="modal-header"> 
                                                    ...
                                                    <h4 class="modal-title">Add Chat Product</h4> 
                                                </div> 
                                               <form action="#"  id="form" method="post"> 
                                                ...
                                                <div class="modal-body"> 
                                                      ...
                                                      <input type="text" name="productid"   class="form-control" readonly id="productid">
                                                    </div>
                                                    <div class="form-group">
                                                      <label for="emailAddress">Product Name*</label>
                                                      <input type="text" name="productname"  placeholder="Product Name" onblur="checkproductname()" class="form-control" id="productname">
                                                      <span class="help-block"></span>
                                                       <div class="valid"></div>
                                                    </div>

                                                     <div class="form-group">
                                                      <label for="emailAddress">Rate*</label>
                                                      <input type="text" name="rate" placeholder="Rate" class="form-control decimal" id="rate">
                                                      <span class="help-block"></span>
                                                    </div>
    ...
    z-index:1032;
       ...
       <script type="text/javascript">
        $(document).ready(function(){
            $('#addproduct').attr('class','has-submenu active');
...
$(document).ready(function() {
    ...
    table = $('#table').DataTable({ 
        ...
        "ajax": {
            "url": "<?php echo site_url('admin/chats_product/ajax_list')?>",
            "type": "POST"
        },
...
function add_person()
{
    ...
    $('.modal-title').text('Add Chat Product'); // Set Title to Bootstrap modal title
     
    $.post('<?php echo base_url();?>admin/chats_product/addproductid',function(data){
...
function edit_person(id)
{
    ...
    $.ajax({
        url : "<?php echo site_url('admin/chats_product/ajax_edit/')?>/" + id,
        type: "GET",
        dataType: "JSON",
        success: function(data)
        {
            ...
            $('.modal-title').text('Edit Chat Product'); // Set title to Bootstrap modal title
...
function delete_person(id)
{
    if(confirm('Are you sure delete this Product?'))
    {
        ...
        $.ajax({
            url : "<?php echo site_url('admin/chats_product/ajax_delete')?>/"+id,
            type: "POST",
            dataType: "JSON",
            success: function(data)
            {
...
function checkproductname()
{
    ...
    //alert(category);
     ...
     $.post('<?php echo base_url();?>admin/chats_product/checkproductname',{'productname':productname},function (data){
...
function reload_table()
{
 ...
 $('#btnSave').text('saving...'); //change button text
    ...
    if(save_method == 'add') {
        url = "<?php echo site_url('admin/chats_product/ajax_add')?>";
    } else {
        url = "<?php echo site_url('admin/chats_product/ajax_update')?>";
    }
